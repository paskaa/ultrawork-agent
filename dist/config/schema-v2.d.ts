...
export declare const DEFAULT_AGENTS_V2: Record<string, AgentConfig>;
export declare const DEFAULT_CATEGORIES_V2: Record<string, CategoryConfig>;
export declare const DEFAULT_ROUTING_RULES_V2: TaskRoutingRule[];
export declare const MODEL_MAPPING: {
    gmodel: {
        name: string;
        provider: string;
        modelId: string;
 ...
 * 批量解析模型配置
 */
export declare function resolveAgentConfig(agentConfig: AgentConfig): AgentConfig;
/**
 * 解析所有武将配置
 */
export declare function resolveAllAgents(): Record<string, AgentConfig>;
/**
 * 解析所有类别配置
 */
export declare function resolveAllCategories(): Record<string, CategoryConfig>;
