...
| 部将 | 专长 | 任务类型 |
|------|------|----------|
| **SimaShi** | 深度分析专家 | 架构探索、代码深度分析、复杂问题定位 |
| **SimaZhao** | 信息整理专家 | 文档生成、知识提炼、信息汇总 |
...
```
// 并行探索和分析
Task({subagent_type: "simashi", prompt: "深度分析代码架构..."})
Task({subagent_type: "simazhao", prompt: "整理API文档信息..."})
```

### 典型场景

| 场景 | SimaShi任务 | SimaZhao任务 |
|------|-------------|--------------|
| 代码探索 | 架构深度分析 | 生成结构文档 |
| 问题定位 | 根因深度分析 | 整理问题清单 |
| 技术调研 | 技术深度调研 | 汇总调研报告 |
